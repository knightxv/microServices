...
import (
	"context"
	api "micro_services/pkg/base_info"
	"micro_services/pkg/common/config"
	"micro_services/pkg/common/log"
	"micro_services/pkg/common/token_verify"
	"micro_services/pkg/grpc-etcdv3/getcdv3"
	rpc "micro_services/pkg/proto/auth"
	micro_services_sdk "micro_services/pkg/proto/sdk_ws"
	"micro_services/pkg/utils"
	"net/http"
	"strings"
...
func UserRegister(c *gin.Context) {
	...
	req := &rpc.UserRegisterReq{UserInfo: &micro_services_sdk.UserInfo{}}
